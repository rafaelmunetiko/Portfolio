...
const translations = {
    'pt-br': {
        ...
        'portfolio_project1_title': 'SlateScope',
        'portfolio_project1_desc': 'Aplicativo web de filmes desenvolvido com React, Vite e CSS, que consome uma API para exibir informações detalhadas dos títulos.',
        ...
        'certificate_cloud': 'Cloud Fundamentals, Administration and Solution Architect',
        'certificate_devops': 'DevOps & Agile Culture',
    ...
    'en': {
        ...
        'portfolio_project1_title': 'SlateScope',
        'portfolio_project1_desc': 'Movie web app built with React, Vite, and CSS, consuming an API to display detailed movie information.',
